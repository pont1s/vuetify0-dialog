//#region ../../node_modules/.pnpm/@js-temporal+polyfill@0.5.1/node_modules/@js-temporal/polyfill/index.d.ts
declare namespace Temporal {
   ...
   */
  export type RoundTo<T extends DateTimeUnit> = SmallestUnit<T> | {
    /**
   ...
   */
  export type DurationRoundTo = SmallestUnit<DateTimeUnit> | (({
    /**
   ...
   */
  export type DurationTotalOf = TotalUnit<DateTimeUnit> | {
    /**
  ...
  type LocalesArgument = ConstructorParameters<typeof Intl.DateTimeFormat>[0]; // Provide a quick replacement for Intl.DurationFormatOptions if not in TS
  type DurationFormatOptions = typeof Intl extends {
    DurationFormat: any;
  } ? ConstructorParameters<(typeof Intl)['DurationFormat']>[1] : Record<string, unknown>;
  ...
  export class Duration {
    ...
    static compare(one: Temporal.Duration | DurationLike | string, two: Temporal.Duration | DurationLike | string, options?: DurationArithmeticOptions): ComparisonResult;
  ...
  export class Instant {
    ...
    subtract(durationLike: Omit<Temporal.Duration | DurationLike, 'years' | 'months' | 'weeks' | 'days'> | string): Temporal.Instant;
    until(other: Temporal.Instant | string, options?: DifferenceOptions<'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>): Temporal.Duration;
    since(other: Temporal.Instant | string, options?: DifferenceOptions<'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>): Temporal.Duration;
  ...
  export class PlainDate {
    ...
    static compare(one: Temporal.PlainDate | PlainDateLike | string, two: Temporal.PlainDate | PlainDateLike | string): ComparisonResult;
    ...
    until(other: Temporal.PlainDate | PlainDateLike | string, options?: DifferenceOptions<'year' | 'month' | 'week' | 'day'>): Temporal.Duration;
    since(other: Temporal.PlainDate | PlainDateLike | string, options?: DifferenceOptions<'year' | 'month' | 'week' | 'day'>): Temporal.Duration;
  ...
  export class PlainDateTime {
    ...
    static compare(one: Temporal.PlainDateTime | PlainDateTimeLike | string, two: Temporal.PlainDateTime | PlainDateTimeLike | string): ComparisonResult;
    constructor(isoYear: number, isoMonth: number, isoDay: number, hour?: number, minute?: number, second?: number, millisecond?: number, microsecond?: number, nanosecond?: number, calendar?: string);
    readonly era: string | undefined;
    readonly eraYear: number | undefined;
    readonly year: number;
    readonly month: number;
    ...
    until(other: Temporal.PlainDateTime | PlainDateTimeLike | string, options?: DifferenceOptions<'year' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>): Temporal.Duration;
    since(other: Temporal.PlainDateTime | PlainDateTimeLike | string, options?: DifferenceOptions<'year' | 'month' | 'week' | 'day' | 'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>): Temporal.Duration;
    round(roundTo: RoundTo<'day' | 'hour' | 'minute' | 'second' | 'millisecond' | 'microsecond' | 'nanosecond'>): Temporal.PlainDateTime;
  ...
  export class PlainYearMonth {
    ...
    static compare(one: Temporal.PlainYearMonth | PlainYearMonthLike | string, two: Temporal.PlainYearMonth | PlainYearMonthLike | string): ComparisonResult;
  ...
  export class ZonedDateTime {
    ...
    static compare(one: Temporal.ZonedDateTime | ZonedDateTimeLike | string, two: Temporal.ZonedDateTime | ZonedDateTimeLike | string): ComparisonResult;
...
declare namespace Intl {
  type Formattable = Date | Temporal.Instant | Temporal.ZonedDateTime | Temporal.PlainDate | Temporal.PlainTime | Temporal.PlainDateTime | Temporal.PlainYearMonth | Temporal.PlainMonthDay;
...
//#endregion
export { Temporal as n, DateAdapter as t };